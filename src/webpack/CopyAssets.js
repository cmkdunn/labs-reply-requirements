...
function getCopyPatterns(destination, projectRoot)
{
  ...
  if (destination == 'target') {
    patternsForTarget = [
      {
        from: path.resolve(projectRoot, 'node_modules', '@deskproapps', 'deskproapps-sdk-core', 'dist', 'deskproapps-sdk-core.js'),
        to: path.join(projectRoot, 'target', 'assets', 'deskproapps-sdk-core.js'),
        force: true
      },
      {
